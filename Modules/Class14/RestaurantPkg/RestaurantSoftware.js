class RestaurantSoftware {
    ...
    register(restaurantName, restaurantMaxCapacity, restaurantEmployeeCount) {
        if (restaurantMaxCapacity>0 && restaurantEmployeeCount>0 && typeof restaurantName === 'string') {
            ...
            // need to add code to generate and update rData.id
            console.log(`\nregister: Thank you for registering your restaurant. You restaurant id is COMING SOON...`);
        } else {
            console.log(`\nregister: Invalid data supplied.\nRestaurant Name: ${restaurantName}\nRestaurant max capacity: ${restaurantMaxCapacity}\nRestaurant employee count: ${restaurantEmployeeCount}`);
        }
    }
